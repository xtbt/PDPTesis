...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_HEADER.PHP"); ?>
        ...
        <main>
            <section id="mainUI">
                ...
                <p><a href="<?php echo BASE_DIR; ?>frontend/incidents/tickets_form.php"><img src="<?php echo BASE_DIR; ?>frontend/assets/images/new-ticket.png" /> Nuevo ticket</a></p>
                
                <form id="frm_filter" method="post">
                <fieldset>
                    <input type="hidden" id="hdn_entity" name="hdn_entity" value="<?php echo MODULE_NAME; ?>" />
                    <input type="text" id="txt_criteria_filter" name="txt_criteria_filter" placeholder="ID/Categor&#237;a/Subcategor&#237;a" value="" />
                ...
                <table id="tblTickets">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Categor&#237;a/Subcategor&#237;a</th><?php $tbl_cols++; ?>
                            <th>Descripci&#243;n</th><?php $tbl_cols++; ?>
