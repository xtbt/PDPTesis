...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_HEADER.PHP"); ?>
        ...
        <main>
            <section id="mainUI">
                ...
                <p><a href="<?php echo BASE_DIR; ?>frontend/admin/general/areas/crud_form.php"><img src="<?php echo BASE_DIR; ?>frontend/assets/images/general-areas-new.png" /> Nueva &#225;rea</a></p>
                ...
                <table id="tblAreas">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Nombre de &#225;rea</th><?php $tbl_cols++; ?>
...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_FOOTER.PHP"); ?>
    ...
    <script type="text/javascript" src="<?php echo BASE_DIR; ?>frontend/scripts/admin/general/areas_list.js"></script>
