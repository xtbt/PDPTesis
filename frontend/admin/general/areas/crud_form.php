...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_HEADER.PHP"); ?>
        ...
        <main>
            <section id="mainUI">
                ...
                <p><a href="<?php echo BASE_DIR; ?>frontend/admin/general/areas/index.php"><img src="<?php echo BASE_DIR; ?>frontend/assets/images/areas.png" /> Regresar al cat&#225;logo de &#225;reas</a></p>
                
                <form id="frm_areas_crud" method="post">
                <fieldset>
                    <input type="hidden" id="entity" name="entity" value="<?php echo MODULE_NAME; ?>" />
                    <p id="FormMessage"></p>
                    <label>Id: 
                        <input type="text" name="txt_AreaId" id="txt_AreaId" />
                    </label>
                    <label>Nombre: 
                        <input type="text" name="txt_AreaName" id="txt_AreaName" />
                    </label>
                    <label>Status: 
                        <input type="text" name="txt_AreaStatus" id="txt_AreaStatus" />
                    </label>
                    <p>
...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_FOOTER.PHP"); ?>
    ...
    <script type="text/javascript" src="<?php echo BASE_DIR; ?>frontend/scripts/admin/general/areas_form.js"></script>
