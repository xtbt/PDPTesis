...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_HEADER.PHP"); ?>
        ...
        <main>
            <section id="mainUI">
                ...
                <p><a href="<?php echo BASE_DIR; ?>frontend/admin/general/users/crud_form.php"><img src="<?php echo BASE_DIR; ?>frontend/assets/images/users-new.png" /> Nuevo usuario</a></p>
                ...
                <table id="tblUsers">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Nombre de usuario</th><?php $tbl_cols++; ?>
                            <th>Correo @</th><?php $tbl_cols++; ?>
                            <th>No. Tel.</th><?php $tbl_cols++; ?>
                            <th>Nombre(s)</th><?php $tbl_cols++; ?>
                            <th>Apellido(s)</th><?php $tbl_cols++; ?>
                            <th>&#193;rea</th><?php $tbl_cols++; ?>
                            <th>Status</th><?php $tbl_cols++; ?>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_FOOTER.PHP"); ?>
    ...
    <script type="text/javascript" src="<?php echo BASE_DIR; ?>frontend/scripts/admin/general/users_list.js"></script>
