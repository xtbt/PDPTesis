<?php
    ...
    define('MODULE_NAME', 'PROBLEMS-CATEGORIES-LIST');
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_HEADER.PHP"); ?>
        ...
        <main>
            <section id="mainUI">
                <h1>.: Cat&#225;logo de categor&#237;as de fallas :.</h1>
                ...
                <p><a href="<?php echo BASE_DIR; ?>frontend/admin/problems/categories/crud_form.php"><img src="<?php echo BASE_DIR; ?>frontend/assets/images/problems-categories-new.png" /> Nueva categor&#237;a de falla</a></p>
                ...
                <table id="tblProblemsCategories">
                    <?php $tbl_cols = 0; ?>
                    <caption>Listado de Categor&#237;as de Fallas</caption>
                    <thead>
                        <tr>
...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_FOOTER.PHP"); ?>
    ...
    <script type="text/javascript" src="<?php echo BASE_DIR; ?>frontend/scripts/admin/problems/categories_list.js"></script>
