<?php
    ...
    define('MODULE_NAME', 'PROBLEMS-SUBCATEGORIES-CRUD');
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_HEADER.PHP"); ?>
        ...
        <main>
            <section id="mainUI">
                <h1>.: Gesti&#243;n de Subcategor&#237;as de Fallas :.</h1>
                
                <p><a href="<?php echo BASE_DIR; ?>frontend/admin/problems/subcategories/index.php"><img src="<?php echo BASE_DIR; ?>frontend/assets/images/problems-subcategories.png" /> Regresar al cat&#225;logo de subcategor&#237;as de fallas</a></p>
                
                <form id="frm_problems_subcategories_crud" method="post">
                <fieldset>
                    <input type="hidden" id="entity" name="entity" value="<?php echo MODULE_NAME; ?>" />
                    <p id="FormMessage"></p>
                    <label>Id: 
                        <input type="text" name="txt_ProblemSubCategoryId" id="txt_ProblemSubCategoryId" />
                    </label>
                    <label>Categor&#237;a: 
                    ...
                    <label>Nombre: 
                        <input type="text" name="txt_ProblemSubCategoryName" id="txt_ProblemSubCategoryName" />
                    </label>
                    <label>Status: 
                        <input type="text" name="txt_ProblemSubCategoryStatus" id="txt_ProblemSubCategoryStatus" />
                    </label>
                    <p>
...
<?php require(BASE_ROOT."frontend/html-includes/HTML5_BODY_CONTAINER_FOOTER.PHP"); ?>
    ...
    <script type="text/javascript" src="<?php echo BASE_DIR; ?>frontend/scripts/admin/problems/subcategories_form.js"></script>
